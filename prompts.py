...
PROMPT_TEMPLATES: Dict[str, str] = {
    ...
    "cinema": (
        ...
        ВАЖНО: Дом остаётся частным жилым и сохраняется архитектура самого здания, не увеличивай масштаб, сохрани силуэт и основные формы здания.
...
EXTRA_PROMPT_MODE_DESCRIPTIONS: Dict[str, str] = {
    "cinema": (
        f"""
            ...
            Твоя задача — придумать ШЕСТЬ разных коротких текстовых дополнений, которые можно ДОБАВИТЬ В КОНЕЦ основного промта для генерации изображения дома. ВАЖНО сохранить архитектуру и силуэт дома.
            ПРИНЦИПИАЛЬНО ВАЖНО сохранить архитектуру и силуэт дома.
