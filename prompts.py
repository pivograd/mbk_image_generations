...
EXTRA_PROMPT_MODE_DESCRIPTIONS: Dict[str, str] = {
    "cinema": (
        ...
        Подходят эстетики таких фильмов и сериалов: Бегущий по лезвию 2049, Бегущий по лезвию, Дюна, Дюна: Часть вторая, Интерстеллар, Начало, Тёмный рыцарь, Она, Обливион, 
        Гравитация, Аватар, Аватар 2, Трон: Наследие, Матрица, Престиж, Гер, Пляжный бездельник, Зови меня своим именем, Мама!,
        Древо жизни, Под покровом ночи, Джон Уик, Остров проклятых, Сикарио, Драйв, Беверли-Хиллз 90210, Большая маленькая ложь, Острые предметы, Карточный домик, Вестсайдская история, 
        Гран Торино, Сфера, Секреты Лос-Анджелеса, Невероятная жизнь Уолтера Митти, Ла-Ла Ленд, Изгой-один, Мандалорец, Игра престолов, Викинги, Последний из нас, 
        Очень странные дела, Ведьмак, Шерлок, Черное зеркало, Остаться в живых, Пикник у Висячей скалы, Твин Пикс, Паразиты, Сияние.
        ТВОЯ ЗАДАЧА:
    ...
    "base": (
        ...
        Описание режима:
        Base(Базовый) режим.не пишите
        Популярные современные сочетания.
